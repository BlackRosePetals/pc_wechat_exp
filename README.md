...
> 版本：2.4.20260920 | 更新日期：2026-09-20 | 适用 WeChat 4.x（已测试 4.1.9 / 4.1.10 / 4.1.12.55 / 4.1.15.11）| Windows 10/11
...
- 最新版本：`wechat_exp_2.4.20260920.exe` → [点击下载](https://github.com/sunhanaix/pc_wechat_exp/releases/download/v2.4.20260920/wechat_exp_2.4.20260920.exe)

**源码地址**：[https://github.com/sunhanaix/pc_wechat_exp](https://github.com/sunhanaix/pc_wechat_exp)

> ⚠️ **发布提醒**：请先在 GitHub Releases 上传 `dist/wechat_exp_2.4.20260920.exe`（SHA-256：`38073F279F932AB0683A2BA38BB51AF258C8C07970BEFA0B2EC1D6CBED670F25`）并打上 `v2.4.20260920` 标签，链接方可生效。
